...
funcs.json = require('Communication/MultiTCPIPClient/helper/Json')
-- Default parameters for instances of module
funcs.defaultParameters = require('Communication/MultiTCPIPClient/MultiTCPIPClient_Parameters')
